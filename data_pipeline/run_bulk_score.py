...
DOC_SEP = 100257  # <|endoftext|> — OLMo-3 pretraining document separator
PORT = 8390
...
def parse_args():
    ...
    p.add_argument('--model', default='QuantizedModel/Elbaz-Olmo-3-7B-Instruct-abliterated/Elbaz-OLMo-3-7B-Instruct-abliterated-Q8_0.gguf')
...
def main():
    ...
    try:
        ...
        bin_dir = str((HERE.parent / 'LlamaCPPBinaries').resolve())
        server_env['PATH'] = f"{bin_dir};{server_env.get('PATH', '')}"
